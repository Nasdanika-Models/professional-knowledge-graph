package org.nasdanika.models.professionalknowledgegraph.ecore.tests;
...
import org.nasdanika.models.professionalknowledgegraph.ecore.EcoreGenProfessionalKnowledgeGraphProcessorsFactory;
 ...
 *
 */
public class TestProfessionalKnowledgeGraphModelDocGen {
	
	@Test
	public void testGenerateProfessionalKnowledgeGraphModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenProfessionalKnowledgeGraphProcessorsFactory ecoreGenProcessorFactory = new EcoreGenProfessionalKnowledgeGraphProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "professional-knowledge-graph.xmi");
		...
		EcoreHtmlAppGenerator eCoreHtmlAppGenerator = new EcoreHtmlAppGenerator(
				ProfessionalKnowledgeGraphPackage.eINSTANCE, 
				packageURIMap, 
		...
		String siteMapDomain = "https://professional-knowledge-graph.models.nasdanika.org";		
